...
export const GMB_SERVICES: readonly GmbService[] = [
  ...
  { name: "Post-hospital care at home", description: "Nursing and personal care after a hospital stay", href: "/services/post-hospital-care" },
  { name: "Transition care", description: "Support transitioning from hospital or facility to home", href: "/services/hospital-at-home" },
  ...
  { name: "Palliative care support", description: "Compassionate care and symptom management at home", href: "/services/palliative-care" },
